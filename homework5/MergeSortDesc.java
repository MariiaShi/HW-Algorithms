package org.example.algorithms.homework5;
...
public class MergeSortDesc {
    ...
    private static void merge(int[] arr, int[] leftArr, int[] rightArr) {
        ...
        while (leftIndex < leftArrLength && rightIndex < rightArrLength) {
            if (leftArr[leftIndex] > rightArr[rightIndex]) { // ИЗМЕНЁН ЗНАК С < НА > ДЛЯ ИЗМЕНЕНИЯ ПОРЯДКА СОРТИРОВКИ // сравниваем элемент в левом и правом подмассиве
